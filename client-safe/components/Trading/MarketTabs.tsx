...
import LogsViewer from "@/components/BotMonitor/LogsViewer";

import { cn } from "@/utils/classNames";

type TabId = "positions" | "orders" | "markets" | "market-detail" | "bot-monitor" | "logs";
...
const tabs: Tab[] = [
  ...
  { id: "market-detail", label: "Market Detail" },
  { id: "bot-monitor", label: "Bot Monitor" },
  { id: "logs", label: "Logs" },
];
  ...
  return (
    <Card className="p-6">
      ...
      <div>
        ...
        {activeTab === "market-detail" && <MarketDetail />}
        {activeTab === "bot-monitor" && <BotMonitor />}
